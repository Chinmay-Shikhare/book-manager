...
const validation_pipe_1 = require("../util/pipeline/validation.pipe");
let BooksController = class BooksController {
    ...
    update(bookId, updateBookDto) {
        return this.booksService.update(Object.assign(Object.assign({}, updateBookDto), { bookId }));
    }
    delete(bookId) {
...
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)(new validation_pipe_1.ValidatorPipe(create_book_dto_1.CreateBookSchema))),
